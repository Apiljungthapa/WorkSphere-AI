...
class AuthMiddleware(BaseHTTPMiddleware):
    ...
    EXEMPT_PAGES = ["/", "/login", "/check_email", "/ishDetails", "/ishPage", "/static", "/hr_check_password", "/error.html","/upload_file"]
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        # If user is already logged in and tries to access the login page, redirect to error page
        if path == "/login":
